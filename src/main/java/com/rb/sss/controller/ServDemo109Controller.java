...
import com.rb.sss.service.ServDemo109Service;
import com.rb.core.rest.ConfigIdentifier;
import com.rb.core.rest.GenericApi;

@Path("/api/v1/employees")
public class ServDemo109Controller {

    public static final Logger logger = LoggerFactory.getLogger(ServDemo109Controller.class);
	@Inject
	ServDemo109Service service;
